...
with possible sublevel is found then found appenders are used.

   default:
     warning: screen
     error: [screen, file-err]

It's possible to customize logging levels with sublevels.
...
message will go into B<file-debug> appender except one's with sublevel 
